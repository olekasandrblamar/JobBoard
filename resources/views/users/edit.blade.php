...
<div class="col-12">
    <div class="card">
        <div class="card-header pb-0">
            <div>
                <h5 class="card-title fw-normal mb-0">{{ __('global.edit') }}</h5>
            </div>
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <label style="position: relative; top: 20px;">{{ Form::checkbox('allow_login', null, $user->allow_login == 1 ? true : false, array('class' => '')) }} {{ __('global.allowLogin') }}</label>
                </div>
