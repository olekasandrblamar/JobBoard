...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            <!-- <div class="row g-3"> -->
                <form method="POST" action="{{ route('export.subtasks.excute') }}" class="row g-3">
                    @csrf
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <div class="form-group">
                            {!! Form::select('subtask', $subtasks, null, array('class' => 'form-control','single')) !!}
                        </div>
                    </div>
            ...
            <div class="row g-3">
                <div class="col-lg-5 col-md-5 col-sm-12">
                    <a href="http://jobsheet.com/create-excel-file/486" class="btn btn-outline-danger"><i class="fa fa-file-excel-o"></i> <span class="d-lg-inline-flex d-none">Export all of User of SubTask</span></a>
                    <a href="http://jobsheet.com/create-excel-file/486" class="btn btn-outline-success"><i class="fa fa-file-pdf-o"></i> <span class="d-lg-inline-flex d-none">Export all of User of SubTask</span></a>
                </div>
