        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-lg-5 col-md-5 col-sm-12">
                    <a href="http://jobsheet.com/create-excel-file/486" class="btn btn-outline-danger"><i class="fa fa-file-excel-o"></i> <span class="d-lg-inline-flex d-none">Export all of User of WP</span></a>
                    <a href="http://jobsheet.com/create-excel-file/486" class="btn btn-outline-success"><i class="fa fa-file-pdf-o"></i> <span class="d-lg-inline-flex d-none">Export all of User of WP</span></a>
                </div>
