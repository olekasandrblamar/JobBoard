            ...
            <div class="row mb-4-custom">
                <form method="POST" action="{{ route('export.tasks.excute') }}" class="row g-3">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 txt-right">
                        ...
                        <button id="docBtn" type="submit" class="btn btn-outline-primary mr-1 mb-2"><i class="fa fa-file-word-o"></i> <span class="d-lg-inline-flex d-none">Word</span></button>
                ...
                <form method="POST" action="{{ route('export.tasks.user') }}" class="row g-3">
                    ...
                    <div class="col-12 d-flex-center" style="justify-content: space-between;">
                        ...
                        <div class="ml-1">
                            ...
                            <button id="userDocBtn" type="submit" class="btn btn-outline-primary mr-1 mb-2"><i class="fa fa-file-word-o"></i> <span class="d-lg-inline-flex d-none">Word by Selected User</span></a>
