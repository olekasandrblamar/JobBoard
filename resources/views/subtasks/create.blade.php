...
<div class="page-title mb-lg-4 pb-0">
    <div class="container-fluid">
        <ol class="breadcrumb bg-transparent w-100 li_animate mb-3 mb-md-1">
            ...
            <li class="breadcrumb-item font-size-28">
                <a class="sub-title-color txt-deco" href="{{ route('tasks.edit', $task_id) }}">{{ __('global.subTasks') }}</a>
            </li>
...
<div class="col-12">
    <div class="card">
        <div class="card-header pb-0">
            <h5 class="card-title fw-normal mb-0">{{ __('global.createSubTask') }}</h5>
        ...
        <div class="card-body">
            ...
            {!! Form::open(array('route' => 'subtasks.store','method'=>'POST')) !!}
            {{ Form::hidden('task_id', $task_id) }}
            <div class="row g-3">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group">
                        <strong>{{ __('global.title') }}:</strong>
                        {!! Form::text('title', null, array('placeholder' => __('global.enterSubTaskTitle'),'class' => 'form-control')) !!}
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group">
            ...
            <div class="row g-3 mt-lg-3" style="">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <a class="btn btn-default f-right" href="{{ route('tasks.edit', $task_id) }}"> {{ __('global.cancel') }}</a>
                </div>
            </div>
            {!! Form::close() !!}
        </div>
