        ...
        <div class="card-body">
            ...
            <table class="table table-custom mb-0 mt-lg-4 mydata-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td id="order_id{{$task->id}}">{{ $task->order }}</td>
                        ...
                        <td>
                            ...
                            <button class="dropdown-item btn-order-change" data-taskKey="{{ $task->id }}" data-taskOrder="{{ $task->order }}" data-taskTitle="{{ $task->title }}"><i class="me-3 fa fa-sort"></i>{{ __('global.order') }}</button>
